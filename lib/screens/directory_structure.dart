...
import 'package:scanningapp/screens/view_document.dart';
import 'package:shared_preferences/shared_preferences.dart';

import '../models/directory_docs_model.dart';
import '../repository/directory_strucuture_repo.dart';
...
class FileExplorerApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primaryColor: Color(0xFF1998D5),
        colorScheme: ColorScheme.fromSeed(
          seedColor: Color(0xFF1998D5),
          primary: Color(0xFF1998D5),
...
class _FileExplorerScreenState extends State<FileExplorerScreen>
  ...
  @override
  Widget build(BuildContext context) {
    print("currentPath ${currentPath.length}");
    return WillPopScope(
          ...
          headerSliverBuilder: (context, innerBoxIsScrolled) {
            return [
              SliverAppBar(
                ...
                //               context,
                //               MaterialPageRoute(
                //                   builder: (context) => ShowDocumentsTab()));
                //         },
                ...
                leading: Container(
                  ...
                  decoration: BoxDecoration(
                    color: item.isDirectory
                        ? Colors.blue[50]
                        : _getFileColorByType(item.type.split('/')[1]),
                  ...
                  child: Center(
                    child: Icon(
                      item.isDirectory
                          ? Icons.folder
                          : _getIconByFileType(item.type.split('/')[1]),
                      color: item.isDirectory
